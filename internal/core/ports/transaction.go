...
type TransactionService interface {
	...
	GetAllTransaction(ctx context.Context, page int, limit int) ([]*domain.Transaction, int, error)
}
type TransactionRepository interface {
	...
	GetAllTransaction(ctx context.Context, limit int, offset int) ([]*domain.Transaction, int, error)
}
